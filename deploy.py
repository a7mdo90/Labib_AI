...
class LabibDeployer:
    ...
    def check_prerequisites(self) -> bool:
        ...
        prerequisites = {
            'vision-ocr-key.json': 'Google Cloud Vision API key file',
            '.env': 'Environment variables file',
            'labib_bot.py': 'Main bot script',
...
"""
        ...
        service_file = self.project_root / "labib-bot.service"
...
"""
        ...
        start_file = self.project_root / "start-bot.sh"
...
"""
        ...
        stop_file = self.project_root / "stop-bot.sh"
...
"""
        ...
        restart_file = self.project_root / "restart-bot.sh"
